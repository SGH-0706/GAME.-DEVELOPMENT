...
{ int gd = DETECT, gm; int xa, xb, ya, yb; int dx, dy, x, y, xend, p;
...
while (x < xend) { x++; if (p < 0) { p += 2 * dy; } else { y++; p += 2 * (dy - dx); } putpixel(x, y, 6); }
...
**Output :**
![gdt exp 2](https://github.com/user-attachments/assets/5625229d-f391-4e45-bae5-7b27b42f9c88)
